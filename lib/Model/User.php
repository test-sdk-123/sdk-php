...
class User implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets username
     *
     * @param string|null $username User supplied username
     *
     * @return self
     */
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) < 4)) {
            throw new \InvalidArgumentException('invalid length for $username when calling User., must be bigger than or equal to 4.');
        }
